...
public class Example11 {
    ...
    private static final int AMOUNT_WRITE = 20;
    ...
    public static void main(String[] args) {
        ...
        printStringMod3(map);
        System.out.println("Multi key, where string length > 5:" + multi(map));
    }
    private static void printStringMod3(Map<Integer, String> map) {
        map.entrySet().stream().filter(e -> e.getKey() % 3 == 0).forEach(e ->
