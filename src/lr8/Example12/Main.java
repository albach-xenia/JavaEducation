...
public class Main {
    ...
    private static void start() throws Exception {
        var fileInfo = Program.readFileToCollection("C:\\tmp\\f1.txt");
        ...
        for (int i = 0; i < fileInfo.size(); i++) {
            ...
            Program.writeParamsToFile("C:\\tmp\\f2.txt", true, String.format("%d - ", i + 1));
            Program.writeCollectionToFile("C:\\tmp\\f2.txt", true, wordsToFile, ", ");
            Program.writeParamsToFile("C:\\tmp\\f2.txt", true, String.format(" (%d слов(а))\n", wordsToFile.size()));
        }
    }
